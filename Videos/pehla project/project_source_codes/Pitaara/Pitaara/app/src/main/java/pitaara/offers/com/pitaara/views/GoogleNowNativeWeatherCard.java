...
package pitaara.offers.com.pitaara.views;
...
public class GoogleNowNativeWeatherCard extends CardWithList {
    ...
    protected CardHeader initCardHeader() {
            ...
            public void onMenuItemClick(BaseCard card, MenuItem item) {
                ...
                switch (item.getItemId()){
                    case R.id.action_add:
                        ...
                        w1.city ="Madrid";
                        w1.temperature = 24;
                     //   w1.weatherIcon = R.drawable.ic_action_search;
        ...
        header.setTitle("My Account"); //should use R.string.
        return header;
    }
...
*/
    ...
    protected List<ListObject> initChildren() {
        ...
        w1.city ="Current Balance:";
        w1.temperature = 16;
       // w1.weatherIcon = R.drawable.ic_action_about;
        ...
        w2.city ="Total Money";
        w2.temperature = 25;
     //   w2.weatherIcon = R.drawable.ic_action_faqs;
        ...
        w3.city ="Earned Money:";
        w3.temperature = 19;
      //  w3.weatherIcon = R.drawable.ic_action_dashboard;
    ...
    public class WeatherObject extends DefaultListObject{
     ...
     //   public int weatherIcon;
        ...
        public String temperatureUnit="INR";
